...
from planning_utils import a_star, heuristic, create_grid, create_graph, generate_path
...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        print('North: {}, East: {}, Down: {}'.format(north,east,down))     
...
if __name__ == "__main__":
    ...
    conn = MavlinkConnection('tcp:{0}:{1}'.format(args.host, args.port),threaded=False, timeout=60000)
